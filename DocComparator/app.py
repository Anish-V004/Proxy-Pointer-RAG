...
from src.extraction.extract_pdf_to_md import extract_to_md
from src.indexing.build_doc_index import (
    build_comparator_index, get_doc_id, GeminiEmbeddings,
    build_skeleton_trees
)
from src.validation.criteria_validator import (
    validate_criteria,
    build_section_selection_query,
    build_cross_retrieval_query,
    build_comparison_prompt,
)
from src.comparison.section_selector import select_relevant_sections, load_full_section_text
from src.comparison.cross_retriever import retrieve_matching_sections
from src.comparison.section_comparator import (
    compare_sections, extract_rating
)
from src.report.report_builder import (
